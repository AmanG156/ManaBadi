              ...
              <div className={classes.dropdownWrap}>
                <div className={classes.studentcourse}>
                  <Dropdown
                    ...
                    icon={<HomeIcon onClick={() => refreshList()} />}
                  />
                </div>
            ...
            {view === 'listView'
              ? (
                <Grid container className={classes.resourcesListView}>
                  ...
                  <ListView tableData={resources} typeResources="teacher" selectedResource={setSelectedResource} />
                </Grid>
              )
              : (
                <Grid container className={classes.resourcesGridView}>
                  {setLocalStorage('myResourceView', 'gridView')}
                  <GridView data={resources} typeResources="teacher" selectedResource={setSelectedResource} />
                </Grid>
              )}
          </Grid>
        </Stack>
