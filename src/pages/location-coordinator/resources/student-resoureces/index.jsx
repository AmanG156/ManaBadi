...
// import ListViewIcon from '../../../../assets/svg-jsx/listViewIcon';
...
import { getStudentResourceWRTCourse } from '../../../../store/actions/getResources';
...
export default function ResourcesData() {
  ...
  const handleChange = (event) => {
    dispatch(getStudentResourceWRTCourse({
